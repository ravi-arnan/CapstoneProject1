    ...
    <div class="flex-col lg:flex lg:flex-row justify-between items-center">
      ...
      <div class="lg:w-1/2 xl:w-[46%] lg:order-1" id="img-text">
        ...
        >
          Get Your Food
          <i
            class="fa-solid fa-burger text-4xl xl:text-5xl text-paleBlue ml-1"
          ></i>
          Begin Your Journey
        </h1>
        <p
...
onMounted(() => {
  ...
  gsap.to("#hero-desc", {
    ...
    ease: "power1.in",
    delay: 2.5,
    text: "Fuel your journey with delicious food and drinks, and you'll feel completely prepared for any adventure ahead.",
  });

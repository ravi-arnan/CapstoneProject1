      ...
      <div class="flex container justify-between mx-auto items-center">
        <div class="flex items-center gap-20 lg:gap-10 xl:gap-20">
          <div class="flex gap-2 items-center">
            <h1 class="font-Sawa font-medium text-xl text-paleBlue">BloxFood</h1>
            <img :src="logo" alt="blox" class="w-6 h-6"/>
          </div>
...
import logo from "../assets/blox.png";
...
const links = [
  { label: "Home", href: "#" },
  { label: "Menu", href: "#" },
  { label: "Successful Adventure", href: "#" },
  { label: "FAQ", href: "#" },
];
...
const scrollToAbout = () => {
  const aboutElement = document.getElementById("food-lists");
